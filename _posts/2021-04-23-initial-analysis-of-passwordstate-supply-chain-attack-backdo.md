---
title: "Initial  analysis of PasswordState supply chain attack backdoor code"
date: 2021-04-23
categories: [malware-analysis, reverse-engineering]
tags: [macos, windows, malware, reverse-engineering, web3, supply-chain, ios]
description: "One hour ago, I became aware of this supply chain attack from tweet by Kim Zetter. If you don’t follow her please do and subscribe to her…"
toc: true
image:
  path: /assets/images/posts/initial-analysis-of-passwordstate-supply-chain-attack-backdo/img-06.png
  alt: "Initial  analysis of PasswordState supply chain attack backdoor code"

---

*One hour ago, I became aware of this supply chain attack from tweet by Kim Zetter. If you don’t follow her please do and subscribe to her…*

![Photo by Claudio Schwarz | @purzlbaum on Unsplash](/assets/images/posts/initial-analysis-of-passwordstate-supply-chain-attack-backdo/img-02.png)
_Photo by Claudio Schwarz | @purzlbaum on Unsplash_

**UPDATE** — 24 April 2021: The second stage payload was shared with me by Peter Kruse (@[PeterKruse](https://twitter.com/peterkruse)) thanks to him. Please find the second stage payload analysis at the end of this document.

One hour ago, I became aware of this supply chain attack from a tweet by Kim Zetter. If you don’t follow her please do and subscribe to her blog for amazing cyber espionage related content : [zetter@substack.com](mailto:zetter@substack.com)


> **Tweet**: [https://twitter.com/KimZetter/status/1385674580660916228](https://twitter.com/KimZetter/status/1385674580660916228)
...
![source:https://www.csis.dk/newsroom-blog-overview/2021/moserpass-supply-chain/](/assets/images/posts/initial-analysis-of-passwordstate-supply-chain-attack-backdo/img-03.png)
_source:https://www.csis.dk/newsroom-blog-overview/2021/moserpass-supply-chain/_
...
![image](/assets/images/posts/initial-analysis-of-passwordstate-supply-chain-attack-backdo/img-04.png)


![clean vs backdoored](/assets/images/posts/initial-analysis-of-passwordstate-supply-chain-attack-backdo/img-05.png)
_clean vs backdoored_
...
![image](/assets/images/posts/initial-analysis-of-passwordstate-supply-chain-attack-backdo/img-06.png)


![clean vs backdoored version](/assets/images/posts/initial-analysis-of-passwordstate-supply-chain-attack-backdo/img-06.png)
_clean vs backdoored version_
...
![source :https://www.csis.dk/newsroom-blog-overview/2021/moserpass-supply-chain/](/assets/images/posts/initial-analysis-of-passwordstate-supply-chain-attack-backdo/img-06.png)
_source :https://www.csis.dk/newsroom-blog-overview/2021/moserpass-supply-chain/_
...
This method will load the assembly (the downloaded file) and will execute a method “Invoke”, invoked with null parameters (Invoke(null, null)). We at this point assume that this second stage downloaded is ultimately a valid PE file (after being AES decrypted).

Note: based on the AES ECB decryption function below, this file, should be a valid base64 blob.


![AESDecrypt function from Moserware.SecretSplitter.dll](/assets/images/posts/initial-analysis-of-passwordstate-supply-chain-attack-backdo/img-06.png)
_AESDecrypt function from Moserware.SecretSplitter.dll_
...
meta:
    ...
    strings:
        ...
        $s4 = "upgrade_service_upgrade.zip" wide
```
...
**UPDATE** — 24 April 2021: The second stage payload was shared with me by Peter Kruse (@[PeterKruse](https://twitter.com/peterkruse)) thanks to him. Please find the second stage payload analysis below:
...
![passwordstate-18ed2[.]kxcdn.com](/assets/images/posts/initial-analysis-of-passwordstate-supply-chain-attack-backdo/img-06.png)
_passwordstate-18ed2[.]kxcdn.com_
