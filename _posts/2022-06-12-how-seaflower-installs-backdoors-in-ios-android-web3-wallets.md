---
title: "How SeaFlower 藏海花 installs backdoors in iOS/Android web3 wallets to steal your seed phrase"
date: 2022-06-12
categories: [malware-analysis, reverse-engineering]
tags: [macos, linux, malware, reverse-engineering, web3, javascript, threat-intelligence, ios]
description: "During the course of our work at Confiant, we see malicious activity on a daily basis. What matters the most for us is the ability to:"
toc: true
image:
  path: /assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-04.png
  alt: "How SeaFlower 藏海花 installs backdoors in iOS/Android web3 wallets to steal your seed phrase"
...
![Photo by Sara Kurfeß on Unsplash](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-07.png)
_Photo by Sara Kurfeß on Unsplash_

During the course of our work at [Confiant](https://www.confiant.com/), we see malicious activity on a daily basis. What matters the most for us is the ability to:
...
![Author username leak](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-08.png)
_Author username leak_
...
Naturally, Googling “Zhang Haike” was the next step, which gave many Chinese-speaking references, including this one that I found amusing: it is the name of a [character](https://daomu-biji.fandom.com/wiki/Zhang_Haike) in a Chinese [novel](https://daomu-biji.fandom.com/wiki/Tibetan_Sea_Flower_%28Zang_Hai_Hua%29) called “Tibetan Sea Flower”.
...
As of today, the main current objective of SeaFlower is to modify [web3 wallets](https://moralis.io/what-is-a-web3-wallet-web3-wallets-explained/) with backdoor code that ultimately exfiltrates the seed phrase.

The targeted web3 wallets are the following:

- [Coinbase Wallet](https://twitter.com/CoinbaseWallet) (iOS, Android)
- [MetaMask](https://twitter.com/MetaMask) wallet (iOS, Android)
- [TokenPocket](https://twitter.com/TokenPocket_TP) (iOS, Android)
- [imToken](https://twitter.com/imTokenOfficial) (iOS, Android)
...
![Intercepting HTTPS traffic of SeaFlower backdoor](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-09.png)
_Intercepting HTTPS traffic of SeaFlower backdoor_
...
![imToken cloned website (courtesy of DomainTools) hosted at: appim[.]xyz](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-04.png)
_imToken cloned website (courtesy of DomainTools) hosted at: appim[.]xyz_


![cloned Metamask website, hosted at: https://74871011[.]huliqianbao[.]com/download.html](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-10.png)
_cloned Metamask website, hosted at: https://74871011[.]huliqianbao[.]com/download.html_


![cloned Coinbase Wallet website hosted at som-coinbase[.]com](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_cloned Coinbase Wallet website hosted at som-coinbase[.]com_


![cloned token pocket website hosted at fastrpo[.]com](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_cloned token pocket website hosted at fastrpo[.]com_
...
![image](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
...
![iPhone with multiple installed backdoored wallets](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_iPhone with multiple installed backdoored wallets_
...
![SeaFlower targeting via search engine results](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_SeaFlower targeting via search engine results_
...
![SeaFlower intermediate Fingerprinting](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_SeaFlower intermediate Fingerprinting_
...
![Chinese search engines targeted by SeaFlower](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_Chinese search engines targeted by SeaFlower_
...
![backdoor code injected inside main.jsbundle](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_backdoor code injected inside main.jsbundle_


![zoomed in backdoor code injected inside main.jsbundle](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_zoomed in backdoor code injected inside main.jsbundle_
...
![injected .dylib’s into MetaMask wallet iOS app](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_injected .dylib’s into MetaMask wallet iOS app_
...
![Cycript, Susbtrate and Reveal linked/injected with libmetaDylib.lib](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_Cycript, Susbtrate and Reveal linked/injected with libmetaDylib.lib_
...
![Reveal Framework installed on the backdoored metamask ios app](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_Reveal Framework installed on the backdoored metamask ios app_
...
I’ve found multiple references to MonkeyDev Framework which is a hooking & modding utility written by [AloneMonkey](https://github.com/AloneMonkey). MonkeyDev has custom Xcode templates [https://github.com/AloneMonkey/MonkeyDev-Xcode-Templates](https://github.com/AloneMonkey/MonkeyDev-Xcode-Templates) which make it fully integrated to Xcode during the development cycle of these backdoors!


![MonkeyDev xcode template](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_MonkeyDev xcode template_
...
![highlighted weird looking class name](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_highlighted weird looking class name_

> OCMethodTrace is reference to the OCMethodTrace tool written by Michael Chen aka [omxcodec](https://github.com/omxcodec) , enabling tracing of objective-C classes/methods. OCMethodTrace is also part of MonkeyDev xcode templates: [https://github.com/AloneMonkey/MonkeyDev-Xcode-Templates/blob/master/MonkeyAppLibrary.xctemplate/Trace/OCMethodTrace.h](https://github.com/AloneMonkey/MonkeyDev-Xcode-Templates/blob/master/MonkeyAppLibrary.xctemplate/Trace/OCMethodTrace.h)

Cross-referencing the class name **FKKKSDFDFFADS **I got a solid hit on a Logos tweak installed by the backdoor author, targeting the function **dataWithContentsOfFile**:**options**:**error **the tweek was installed via [**MSHookMessageEx**](http://www.cydiasubstrate.com/api/c/MSHookMessageEx/)**()**


![tweek defined in _logosLocalInit() function](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_tweek defined in _logosLocalInit() function_

> Logos is a Perl regex-based preprocessor that simplifies the boilerplate code needed to create hooks for Objective-C methods and C functions with an elegant Objective-C-like syntax. It’s most commonly used along with the [Theos](https://theos.dev/docs/) build system, which was originally developed to create jailbreak tweaks
...
![backdoor code called](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_backdoor code called_
...
![there’s a function at 0x1001339cc callingdataWithContentsOfFile:options:error](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_there’s a function at 0x1001339cc callingdataWithContentsOfFile:options:error_

This function is called by **RCTJavascriptLoader::loadBundleAtURL**


![image](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-37.png)

At this point, we can conclude that the author is trying to inject a backdoor in the form of a React Native Bundle and have it loaded by [**RCTJavascriptLoader**](https://github.com/facebook/react-native/blob/main/React/Base/RCTJavaScriptLoader.h)** **used by the **RCTBridge** to load javascript.
...
![image](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-38.png)


![decompilation ofFKKKSDFDFFADS::ddsdf](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_decompilation ofFKKKSDFDFFADS::ddsdf_

Interesting :) I can see base64 blob of typical RSA pivate key/ public keys What this function does is RSA decrypting an RSA encrypted blob encoded in b64. The author linked the library with antoher library called SCRSACryptor and found reference to it in github here: [https://github.com/xialun/RSAClass](https://github.com/xialun/RSAClass)
...
![decrypted SeaFlower backdoor](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_decrypted SeaFlower backdoor_

we finally got the missing **startupload()** function :) below is the code of this function:


[View Gist on GitHub](https://gist.github.com/tahaconfiant/e3c6e8e679ffb10f4157b25a28f565e2)
...
![taken from: Rafael de Oleza —Building JavaScript bundles for React Native](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_taken from: Rafael de Oleza —Building JavaScript bundles for React Native_

**xlmnmonic** stores the seed phrase passed to the function **_initFromMnemonic **we can find it in the main.jsbundle:


![xlmnmonic storing the seed phrase](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_xlmnmonic storing the seed phrase_
...
![debuging the backdoor code](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_debuging the backdoor code_

After that I stopped at the function I am interested in **_logos_meta_method$_ungrouped$NSData$dataWithContentsOfFile$options$error$ (**the one added by the backdoor author using [**MSHookMessageEx**](http://www.cydiasubstrate.com/api/c/MSHookMessageEx/)**())**
...
[View Gist on GitHub](https://gist.github.com/tahaconfiant/358504126e428a63884ea770aea00602)
...
![/Users/lanyu](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-47.png)
_/Users/lanyu_
...
![backdoor code can be seen via class-dump of](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_backdoor code can be seen via class-dump of_
...
![coinbase Wallet iOS app with logos tweaks](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_coinbase Wallet iOS app with logos tweaks_
...
![image](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-54.png)
...
![exfiltrated seed phrase from backdoored Coinbase wallet](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_exfiltrated seed phrase from backdoored Coinbase wallet_
...
![backdoor code inside saveMnemonicToStorage()](/assets/images/posts/how-seaflower-installs-backdoors-in-ios-android-web3-wallets/img-11.png)
_backdoor code inside saveMnemonicToStorage()_
...
First of all, know and understand your attack surface (hopefully this blog can help), as well as reading this document listing different attack surfaces crypto wallets could be exposed to : [https://github.com/OWASP/owasp-mstg/blob/master/Document/0x06c-Reverse-Engineering-and-Tampering.md](https://github.com/OWASP/owasp-mstg/blob/master/Document/0x06c-Reverse-Engineering-and-Tampering.md)
...
if you like this content, please ensure to follow me on twitter [@lordx64](https://twitter.com/lordx64?lang=en) and please stay tuned for the part 2.
